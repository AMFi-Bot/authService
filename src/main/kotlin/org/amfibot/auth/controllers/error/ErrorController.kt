package org.amfibot.auth.controllers.error
...
//    fun handleError(ex: Exception, request: HttpServletRequest): ResponseEntity<ExceptionResponse> {
//        val status = request.getAttribute(RequestDispatcher.ERROR_STATUS_CODE)
//        val errorMessageAttribute = request.getAttribute(RequestDispatcher.ERROR_MESSAGE).toString()
//        val statusCode = status?.toString()?.toInt() ?: 500
//
//        val httpStatus = HttpStatus.resolve(statusCode) ?: HttpStatus.INTERNAL_SERVER_ERROR
//        val errorMessage = errorMessageAttribute.ifEmpty { null }
//        return ResponseEntity.status(statusCode)
//            .body(ExceptionResponse(httpStatus, request.requestURL.toString(), errorMessage))
//    }
//}
